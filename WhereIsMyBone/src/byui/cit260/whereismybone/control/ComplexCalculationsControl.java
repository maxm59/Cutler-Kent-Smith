...
public class ComplexCalculationsControl {
    ...
    public int calcSqYard(int width, int length)throws ComplexCalcException{
        Integer yard = null;
        try{
            if (width <= 0)
                return -1;
    ...
    public boolean validateWatts(String guess, int volts, int amps) throws ComplexCalcException {
        try{
    ...
    public boolean validateCubicInches(String guess, int width, int length, int height) throws ComplexCalcException {
        try{
